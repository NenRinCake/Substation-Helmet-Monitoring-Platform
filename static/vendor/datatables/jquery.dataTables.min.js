...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"最初页",sLast:"最末页",sNext:"向后一页",sPrevious:"向前一页"},sEmptyTable:"没有找到符合的结果",sInfo:"显示从 _START_ 到 _END_ 条，共 _TOTAL_ 条",sInfoEmpty:"显示从 0 到 0 条，共 0 条",
sInfoFiltered:"(从总计 _MAX_ 条中得到)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"每页显示 _MENU_ 条",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"搜索：",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"没有匹配的结果"},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
