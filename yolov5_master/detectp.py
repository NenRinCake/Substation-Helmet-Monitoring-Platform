...
def run(
        ...
        save_conf="head,helmet",  # save confidences in --save-txt labels
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='D:\Pycharm\pycharmProject\yolov5_web\static\downloads\\uploaded_image.jpg', help='source')
    ...
    parser.add_argument('--save-conf', default="safe,helmet", action='store_true', help='save confidences in --save-txt labels')
    ...
    parser.add_argument('--project', default=ROOT / 'D:\Pycharm\pycharmProject\yolov5_web\static', help='save results to project/name')
